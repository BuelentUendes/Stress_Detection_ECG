...
def add_static_data(FEATURE_DATA_PATH, output_path, participant_number=30100):
    ...
    demographics_pd = pd.read_csv(os.path.join(FEATURE_DATA_PATH, "demographics.csv"))
    ...
    for file in csv_files:
        ...
        participant_row = demographics_pd[demographics_pd["Participant"] == int(participant_number_id)]
        ...
        participant_features_pd.to_csv(os.path.join(output_path, participant_number_csv))
